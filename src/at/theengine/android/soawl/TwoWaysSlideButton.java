 ...
 */
public class TwoWaysSlideButton extends LinearLayout {
	...
	private OnTwoWaysSlideButtonEventListener listener; 
     ...
     */
	public TwoWaysSlideButton(Context context, AttributeSet attrs) {
		super(context, attrs);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b)
    {
    	...
    	if(!centered){ //center button only once
    		centerButton();
		        ...
		        public boolean onTouch(View v, MotionEvent event) {
		        	...
		        	switch(event.getActionMasked())
		            {
		            	...
		            	case MotionEvent.ACTION_UP:
		            		...
		            		if((int)event.getX() > ((rightEnd - leftEnd) / 3) * 2 ){
		            			listener.onTwoWaysSlide(v, OnTwoWaysSlideButtonEventListener.SlideDirection.RGHT);
		            			handled = true;
		            		}
		            		
		            		if((int)event.getX() < ((rightEnd - leftEnd) / 3)){
		            			listener.onTwoWaysSlide(v, OnTwoWaysSlideButtonEventListener.SlideDirection.LEFT);
		            			handled = true;
		            		}
		            		...
		            		centerButton(); //center button again
    ...
    private void centerButton(){
    	int x = (rightEnd - leftEnd) / 2;
        
		int w = slider.getMeasuredWidth();
	 ...
	 */
    public void setOnTwoWaysSlideButtonEventListener(OnTwoWaysSlideButtonEventListener listener){
