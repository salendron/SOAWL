 ...
 * This is the abstract eventlistener for the SlideButton.
 * Implement this to react on SlideButtonEvents
 */
public abstract class OnSlideButtonEventListener {
	
	/*
	 * Called when the button was dragged to right or left.
	 */
	public abstract void onSlide(View v);
